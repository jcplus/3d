/**
 * water-profiles.js - Native WebGPU water quality profiles
 *
 * Version: 1.0.0
 */
...
export function waterTriangleCount(meshResolution) {
    return meshResolution * meshResolution * 4;
}
export function waterSimulationBytes(resolution) {
